...
if "t5" in model_name:
    tokenizer = T5Tokenizer.from_pretrained('D:\zyp\hub\models--Rostlab--prot_t5_xl_uniref50\snapshots\973be27c52ee6474de9c945952a8008aeb2a1a73', do_lower_case=False )
    model = T5EncoderModel.from_pretrained('D:\zyp\hub\models--Rostlab--prot_t5_xl_uniref50\snapshots\973be27c52ee6474de9c945952a8008aeb2a1a73')
